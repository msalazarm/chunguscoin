...
"""Verify that starting chunguscoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start chunguscoin with -h for help text")
        ...
        self.log.info("Start chunguscoin with -version for version information")
        ...
        self.log.info("Start chunguscoind with -fakearg to make sure it does not start")
