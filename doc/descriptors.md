# Support for Output Descriptors in Chunguscoin Core

Since Chunguscoin Core v0.17, there is support for Output Descriptors. This is a
...
on Chunguscoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Chunguscoin Core wallets, a convenience function `combo` is
