...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.chunguscoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.chunguscointools.com");
        vSeeds.emplace_back("dnsseed.chunguscoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.chunguscointools.com");
        vSeeds.emplace_back("seed-b.chunguscoin.loshan.co.uk");
