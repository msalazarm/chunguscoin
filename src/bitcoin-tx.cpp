...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " chunguscoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  chunguscoin-tx [options] <hex-tx> [commands]  Update hex-encoded chunguscoin transaction\n" +
            "or:     chunguscoin-tx [options] -create [commands]   Create hex-encoded chunguscoin transaction\n" +
            "\n";
